...
bool read_file(char *filename,PLC &plcnet)
{
    ...
    plcnet.parta = new int [plcnet.cell_num/2];
...
void rand_part(PLC &plcnet)
{
    ...
    plcnet.find_max(plcnet.parta,plcnet.parta_num);
    plcnet.find_max(plcnet.partb,plcnet.partb_num);
    cout<<"Done init"<<endl;
...
int FM_algo(PLC &plcnet,int round,int gridsize)
{
    ...
    while(plcnet.maxa_inx>=0 || plcnet.maxb_inx>=0)
    {
        ...
        plcnet.cal_all_gains();
        //cout<<"maxa_inx="<<plcnet.maxa_inx<<" maxb_inx="<<plcnet.maxb_inx<<endl;
        if(plcnet.maxa_inx>-1) plcnet.find_max(plcnet.parta,plcnet.maxa_inx+1);
        if(plcnet.maxb_inx>-1) plcnet.find_max(plcnet.partb,plcnet.maxb_inx+1);
        //plcnet.in_bin_sort(plcnet.parta,plcnet.maxa_inx+1);
        //plcnet.in_bin_sort(plcnet.partb,plcnet.maxb_inx+1);
